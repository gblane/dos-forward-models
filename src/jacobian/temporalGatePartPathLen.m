...
% temporalGatePartPathLen Calculate partial pathlength for a temporal gate.
%
% [l] = temporalGatePartPathLen(rs, r, rd, Vol, tg, optProp, NVA)
%
...
%
% Outputs:
%   l - Partial pathlength of gated time [mm]
