...
% twoLayEffHomoOptProp Calculate effective homogeneous optical properties for a two-layer medium.
%
% [Y] = twoLayEffHomoOptProp(X, rho, opts)
%
...
%   opts    - Struct with fields (Optional [default]):
...
%               Y(:, 1): Effective homogeneous absorption coefficient [1/mm]
%               Y(:, 2): Effective homogeneous reduced scattering coefficient [1/mm]
