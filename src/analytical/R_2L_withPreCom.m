...
% R_2L_withPreCom Two-layer frequency-domain reflectance (requires precomputation).
%
...
%               no    - (If preCom not input) Index of refraction outside [1] [-]
%               B     - (If preCom not input) Radius of 2-layer cylinder [300] [mm]
%               h_end - (If preCom not input) Number of Bessel function zeros [3000] [-]
